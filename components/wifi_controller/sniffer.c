/**
 * @file sniffer.c
 * @brief Implements promiscuous-mode sniffer logic.
 */
#include "sniffer.h"
 ...
 *
 * Forwards captured frames into the event loop, tagged by frame type
...
void wifictl_sniffer_start(uint8_t channel) {
    ...
    // ESP32 cannot switch channel while a STA is connected to our AP
