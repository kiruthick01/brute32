 ...
 * @brief Implements frame analysis: consumes SNIFFER_EVENTS data frames matching
 * the target BSSID and emits EAPoL-Key / PMKID events.
 */
...
static search_type_t search_type;
