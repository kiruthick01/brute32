 ...
 * @brief Structures and constants from 802.11 / 802.1X used for frame parsing.
 */
...
/**
 * @note MIC length actually depends on 802.11-2016 [12.7.3] key_information_t.descriptor_version;
 * fixed at 16 bytes here as we only target WPA/WPA2 (matches upstream tool's assumption).
 * @see Ref: 802.11-2016 [12.7.2]
 */
...
/**
 * @brief Linked list of captured PMKIDs
 */
